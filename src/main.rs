...
use cc_log_viewer::{
    export_session_markdown, export_session_pdf, get_projects, get_session_logs, get_sessions,
    index, live_activity, websocket_handler, AppState,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route(
            "/api/projects/:project/sessions/:session/export/pdf",
            get(export_session_pdf),
        )
